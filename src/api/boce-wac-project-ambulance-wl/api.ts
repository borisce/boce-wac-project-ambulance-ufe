...
export const AppointmentsListApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateAppointment: async (appointmentsList: AppointmentsList, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appointmentsList' is not null or undefined
...
export const AppointmentsListApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateAppointment(appointmentsList: AppointmentsList, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateAppointment(appointmentsList, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const AppointmentsListApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateAppointment(appointmentsList: AppointmentsList, options?: any): AxiosPromise<void> {
            return localVarFp.updateAppointment(appointmentsList, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface AppointmentsListApiInterface {
     ...
     * @memberof AppointmentsListApiInterface
     */
    updateAppointment(appointmentsList: AppointmentsList, options?: AxiosRequestConfig): AxiosPromise<void>;
...
export class AppointmentsListApi extends BaseAPI implements AppointmentsListApiInterface {
     ...
     * @memberof AppointmentsListApi
     */
    public updateAppointment(appointmentsList: AppointmentsList, options?: AxiosRequestConfig) {
        return AppointmentsListApiFp(this.configuration).updateAppointment(appointmentsList, options).then((request) => request(this.axios, this.basePath));
    }
}
